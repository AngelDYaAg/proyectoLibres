...
$IDCOMENTARIO=(integer)$_GET['no'];

$statement = $conexion->query("SELECT ARCHIVORUTA,TIPOARCHIVO FROM comentario_foro WHERE IDCOMENTARIO = $IDCOMENTARIO"); // busca el id de la ruta y tipo de archivo
